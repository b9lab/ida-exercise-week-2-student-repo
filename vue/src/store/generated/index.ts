...
import B9LabOtherWorldB9LabOtherworldOtherworld from './b9lab/other-world/b9lab.otherworld.otherworld'
...
export default { 
  B9LabOtherWorldB9LabOtherworldOtherworld: load(B9LabOtherWorldB9LabOtherworldOtherworld, 'b9lab.otherworld.otherworld'),
